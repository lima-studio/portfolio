...
export const DesktopDepoiments = ({ activeDepoiment, setActiveDepoiment }: Props) => {
    ...
    return (
        <section className="mx-5 py-10 mb-20 md:mb-32 bg-black text-white rounded-3xl h-[500px]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-5 py-8">
                <div>
                    {depoiments.map((depoiment, index) => {
                        const ref = useRef(null);
                        ...
                        return (
                            ...
                            >
                                <motion.h2
                                    initial={{ color: "#ffffff" }}
                                    animate={{ color: activeDepoiment === index ? "#dddddd" : "#ffffff" }} // Muda a cor ao clicar
                                    transition={{ duration: 0.5 }}
                ...
                <div className="h-full">
                    <div className="sticky top-1/3">
                        ...
                        <div className="text-white pl-20 mt-10">
                            <p className="font-medium text-xl uppercase">{depoiments[activeDepoiment].owner.name}</p>
